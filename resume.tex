...
\cvitem{Languages}{Java, C++, Go, Scala, Python, JavaScript, Clojure, Lisp, SQL, Erlang}
\cvitem{Architecture}{Distributed systems, Kubernetes, REST APIs, data processing with Hadoop \& Spark, microservices}
\cvitem{Infrastructure \& Tooling}{Kubernetes, Docker, NixOS, AWS, CI/CD pipelines, Linux \& Unix, encryption, profiling, database design \& optimization, benchmarking}
  ...
  {}
  {
    \begin{itemize}
      ...
      \item Collaborated with cross-functional teams to refactor core RTC
        services to improve performance, scalability, and observability.
    \end{itemize}
  }
...
\cventry
  ...
  {}
  {
    ...
    \item Designed data models and validation workflows enabling rapid editing and publishing of curated transit mapping data provided by on-site contractors.
    \end{itemize}
  }
...
\cventry
  ...
  {}
  {
    \begin{itemize}
      ...
      \item Designed and built data ingestion and aggregation services in Scala and SQL, among the first at Amazon to leverage AWS Redshift.
...
\cventry
  ...
  {}
  {
    ...
    \item Designed and implemented algorithms to allocate and reconcile diverse costs and revenue components, including liquidations, returns, shipping, and promotions, to individual shipments.
