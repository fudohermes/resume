...
\cvitem{Infrastructure \& Tooling}{Kubernetes, Docker, NixOS, AWS, ArgoCD, Prometheus, Grafana, CI/CD pipelines, Linux \& Unix, encryption, profiling, database design \& optimization, benchmarking}
  ...
  {}
  {
    \begin{itemize}
      ...
      \item Created, modified and/or maintained various cloud services in Python
        and Go. Worked extensively with Prometheus and Grafana for monitoring and observability.
      \item Used ArgoCD for continuous deployment and GitOps-based infrastructure management.
    \end{itemize}
  }
  ...
  {}
  {
    \begin{itemize}
      ...
      \item Collaborated with cross-functional teams to refactor core RTC
        services to improve performance, scalability, and observability. Worked extensively with gRPC and Protocol Buffers for service communication.
    \end{itemize}
  }
...
\cventry
  ...
  {}
  {
    ...
    \item Designed data models and validation workflows enabling rapid editing and publishing of curated transit mapping data provided by on-site contractors. Optimized database queries and schemas for complex transit data relationships.
    \end{itemize}
  }
...
\cventry
  ...
  {}
  {
    \begin{itemize}
      ...
      \item Designed and built data ingestion and aggregation services in Scala and SQL, among the first at Amazon to leverage AWS Redshift. Worked with Ruby and Clojure for various internal tools and infrastructure.
